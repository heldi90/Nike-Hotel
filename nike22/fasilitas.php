        ...
        <div class="container-fluid">
            <div class="col-12">
                ...
                <div class="row">
                    ...
                    $query = mysqli_query($conn,"SELECT * FROM dataHotel ORDER BY id DESC");
                    ...
                    <div class="col-md-6 col-lg-6 p-2">
                        <div class="card p-2 bg-none border-none">
                            ...
                            <div class="card-top-img">
                                <img width="100%" height="230" class="cover" src="proses/gambar/<?php echo $row['fotoHotel']; ?>" alt="" srcset="">
                            </div>
                        </div>
                    </div>
                    <?php } ?>
