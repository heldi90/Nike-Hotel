...
<body class="max mx-auto">
    ...
    <div class="text-center">
        ...
        <div class="text-md mb-5">
            <h2 class="h4">Catatan Input Data Reservasi</h2>
        </div>
        <div class="mt-4 col-12 mx-auto">
            <table class="table table-striped">
                <thead>
                    <tr>
                        <th scope="col">ID</th>
                        <th scope="col">Nama Pemesan/Tamu</th>
                ...
                <tbody>
                    ...
                    $query = mysqli_query($conn,"SELECT * FROM LogInput");
                    while($row = mysqli_fetch_array($query)){

                    ?>
                    <tr>

                        <th scope="row">                        <?php echo $row['idInput']; ?></th>
                        <td>                        <?php echo $row['namaPemesan']; ?></td>
                        <td><?php echo $row['kdeBooking']; ?></td>
                        <td><?php echo $row['jmhKamar']; ?></td>
